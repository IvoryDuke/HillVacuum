...
impl Movement
{
    ...
    /// The percentage of the travel spent accelerating from the minimum to the maximum speed
    /// represented by a value between 0 and 100.
    #[inline]
    #[must_use]
    ...
    /// The percentage of the travel spent decelerating from the maximum to the minimum speed
    /// represented by a value between 0 and 100.
    #[inline]
    #[must_use]
...
pub(in crate::map) mod ui_mod
{
    ...
    impl Movement
    {
        ...
        /// maximum to the minimum speed. If needed, adjusts the deceleration value to make
    ...
    impl Node
    {
        ...
        #[inline]
        #[must_use]
        pub(in crate::map::path) fn from_world_pos(pos: Vec2, selected: bool, center: Vec2)
            -> Self
        {
    ...
    impl<'a> NodesWorld<'a>
    {
        ...
        #[inline]
        #[must_use]
        pub fn nth(&self, index: usize) -> NodeWorld
        {
            NodeWorld::new(&self.slice[index], self.center)
        }
    }
    ...
    pub(in crate::map) struct NodesInsertionIter<'a>
    {
        ...
        /// Whether the iterator has already returned the position of the new [`Node`] being
        /// inserted.
