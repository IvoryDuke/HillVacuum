...
impl EditsHistory
{
    ...
    push_edit!(
        ...
        (thing_angle, (identifier: Id, angle: i16), (hv_vec![identifier], EditType::ThingAngle(angle))),
        ...
        (texture_angle, (identifier: Id, value: TextureRotation), (hv_vec![identifier], EditType::TextureRotation(value))),
