            ...
            manual_section!(
                ...
                (
                    ...
                    "Textures must be placed in the assets/textures/ folder to be loaded.\nThe \
                     ...
                     animation of a texture that is not the one of the selected brushes, it needs \
                     to be pressed with the right mouse button.\nTextures can be reloaded while \
                     the application is running through the UI button in the Options \
                     menu.\n\nDefault textures animation can be exported and imported between map \
                     files. The file extension of the animations files is .anms."
                )
            );
